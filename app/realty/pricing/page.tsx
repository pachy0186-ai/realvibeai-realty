            ...
            <div className="bg-white rounded-xl shadow-lg p-8 relative">
              ...
              <ul className="space-y-4 mb-8">
                ...
                <li className="flex items-center">
                  ...
                  <span className="text-gray-700">5 virtual staging credits</span>
                </li>
              </ul>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 relative border-2 border-purple-500">
              ...
              <ul className="space-y-4 mb-8">
                ...
                <li className="flex items-center">
                  ...
                  <span className="text-gray-700">20 virtual staging credits</span>
                </li>
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-green-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 relative">
              ...
              <ul className="space-y-4 mb-8">
                ...
                <li className="flex items-center">
                  ...
                  <span className="text-gray-700">50 virtual staging credits</span>
                </li>
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-green-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
