      ...
      <div className="prose prose-lg max-w-none">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 my-6">
          ...
          <p className="text-blue-800">
            Send an email to <a href="mailto:realvibeairealty@gmail.com" className="font-semibold">realvibeairealty@gmail.com</a> with:
          </p>
        ...
        <p>
          Some data may be retained if required by law, including:
        </p>
        <ul>
        ...
        <p>
          If you don't want complete deletion, you can request:
        </p>
        <ul>
