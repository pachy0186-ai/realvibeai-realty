      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-200 mb-4 max-w-4xl mx-auto leading-relaxed">
            Your AI Virtual ISA engages, qualifies (Hot/Warm/Cold), and books to your calendar.
            Plugs into <strong>Follow Up Boss</strong> today; Lofty &amp; CINC next.
          </p>

          {/* Limited beta counter */}
          <div className="mb-8 animate-fade-in-up inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-3 py-1 text-sm/6 backdrop-blur-sm">
            <span className="text-white/90">Limited beta:</span>
            <span className="font-semibold text-white">
              <BetaCounter />
            </span>
            <span className="text-white/90">seats per metro</span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-purple-200">
              ...
              <p className="text-gray-600 leading-relaxed">
                Qualified leads book directly to your Google Calendar or Calendly—no back-and-forth.
                Your AI ISA manages conflicts, time zones, and confirmations.
              </p>
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-blue-200">
              ...
              <p className="text-gray-600 leading-relaxed">
                Budget, timeline, motivation—your AI ISA asks the right questions and only books with qualified prospects.
              </p>
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-green-200">
              ...
              <p className="text-gray-600 leading-relaxed">
                Direct Follow Up Boss integration today; Lofty &amp; CINC next.
                Conversations, qualification, and bookings sync to your CRM.
              </p>
          ...
          <div className="mt-16 text-center">
            <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-3xl p-12 text-white">
              <h3 className="text-3xl font-bold mb-4">
                Ready to fill your calendar with qualified appointments?
              </h3>
              <p className="text-xl mb-8 opacity-90">
                Join agents who’ve automated their ISA workflow and 10×’d their appointment volume.
              </p>
